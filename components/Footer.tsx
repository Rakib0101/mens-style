		...
		<footer className="bg-[#212121] text-white">
			<div className="container-page flex flex-col md:flex-row items-center justify-between gap-8 py-8 md:py-10">
				...
				<div className="flex items-center gap-3 shrink-0">
					{/* Facebook */}
					<a
						href={content.brand.social.facebook || "https://facebook.com"}
						target="_blank"
					...
					{/* X (Twitter) */}
					<a
						href={content.brand.social.twitter || "https://x.com"}
						target="_blank"
						rel="noopener noreferrer"
					...
					{/* Instagram */}
					<a
						href={content.brand.social.instagram || "https://instagram.com"}
						target="_blank"
						rel="noopener noreferrer"
